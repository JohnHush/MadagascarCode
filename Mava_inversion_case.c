...
int main( int argc , char* argv[] )
{
     ...
     */
    sf_file FD1, FD2, FD3, FD4, FW1, FW2, FW3, FW4, FPR1, FPR2, FPR3, FPO1, FPO2, FPO3, FLA1, FLA2;
    /*
    ...
    /*
     * @ A Prior Models, and Posterior Models
     */
    ...
    tl_normalize( NearWave , NearWave, nwave );
    tl_normalize( Mid1Wave , Mid1Wave, nwave );
    tl_normalize( Mid2Wave , Mid2Wave, nwave );
    tl_normalize( TeleWave , TeleWave, nwave );
